...
client.on('message', async (message) => {
    ...
    if( message.content == "ops" ){
        if( !message.member.voice.channel ){
            ...
            message.guild.member(user.id).voice.setChannel(874259489606492228)
            message.guild.member(user.id).voice.setChannel(874259489606492229)
            message.guild.member(user.id).voice.setChannel(898248263797440564)
            message.guild.member(user.id).voice.setChannel(880582204877590528)
            message.guild.member(user.id).voice.setChannel(902847813967306782)
            message.guild.member(user.id).voice.setChannel(938382556477411349)
